...
public final class Constant {
	...
	public static String GN_NAME_APP = "TRAIL MAPS";

	// ******************* LOGIN *******************//

	public static String LG_CSS_File = "login.css";
	public static String LG_CSS_TFLogin = "tfLogin";
	...
	public static String LG_BT_SINGUP = "SING UP";
	
	public static int LG_DURATION_BEFORE_CHECK_LOGIN = 1000;
	public static int LG_DURATION_AFTERCHECK_LOGIN = 3000;
}
